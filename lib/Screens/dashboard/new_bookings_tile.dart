                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                          flex: 2,
                          child: Text(
                              "${booking.type == "Multiple Day" ? AppServices.splitBookingDate(booking.reportingDate.toString()) : AppServices.formatDate(booking.reportingDate.toString())} At (${booking.reportingTime})",
                              maxLines: 2,
