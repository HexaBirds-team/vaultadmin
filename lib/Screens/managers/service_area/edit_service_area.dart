...
class EditServiceAreaView extends StatefulWidget {
  ServiceAreaClass serviceData;
  EditServiceAreaView({super.key, required this.serviceData});

  @override
  State<EditServiceAreaView> createState() => _EditServiceAreaViewState();
}

class _EditServiceAreaViewState extends State<EditServiceAreaView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: customAppBar(
        context: context,
        autoLeading: true,
        title: Text("Edit Service Area", style: GetTextTheme.sf24_bold),
      ),
      body: Form(
        key: _key,
        child: ListView(
